...
var textEntered = document.querySelector("#item");




function buttonClicked(){            							  //if + button pressed
...
function addItemTodo(text, completed){         							  // Add item intered in header in todo list and create li html elements with text and icons
	...
	complete.addEventListener("click", completeItemTask);      //Event listener for complete - uncomplete items
	...
	button.appendChild(complete);                                // Append childs button
...
function completeItemTask(){
	...
	var target = (parentId === 'todo') ? document.querySelector('#completed'):document.querySelector('#todo');
...
textEntered.addEventListener('keyup', enterPressed);
